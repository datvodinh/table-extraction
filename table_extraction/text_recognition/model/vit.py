...
class VITEncoder(nn.Module):
    def __init__(self, config: VisionTransformerOCRConfig):
        super().__init__()
    ...
    def forward(self, x):
        ...
        ).hidden_states[-1]  # last hidden states


class TrOCRDecoder(nn.Module):
    def __init__(self, config: VisionTransformerOCRConfig) -> None:
        super().__init__()
...
class VisionTransformerOCR(pl.LightningModule):
    def __init__(self, config: VisionTransformerOCRConfig) -> None:
        super().__init__()
        self.config = config
